...
public class AppDetailsView extends JFrame {
	...
	public void initialize() {
		...
		filesButtonPanel.add(Box.createHorizontalStrut(5));
		filesButtonPanel.add(openFileButton);
		...
		mainFrame.setTitle("Edit applications");
	}
	...
	/**
	 * @param openFileButton the openFileButton to set
	 */
